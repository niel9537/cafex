...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2021 at 02:00 AM
...
(4, 'Amplas', '12434566', 'Amplas', '2021-05-18', NULL, 1),
...
(9, 'Southampton', '111111', 'London', '2021-05-27', NULL, 1);
...
(11, 1, 2, 'kopi', 0, 70000, '2021-11-20', '2021-05-26', '2021-05-28', 1),
(12, 1, 2, 'kopi', 47, 70000, '2021-11-20', '2021-05-27', '2021-05-28', 1),
(13, 3, 2, 'Topping', 5, 40000, '2021-11-20', '2021-05-28', '0000-00-00', 1),
(14, 1, 2, 'kopi', 6, 20000, '2021-12-16', '2021-05-28', '0000-00-00', 1),
(15, 7, 2, 'Gula', 2, 10000, '2021-11-13', '2021-05-28', '0000-00-00', 1),
(16, 4, 2, 'Oishi', 3, 10000, '2021-11-11', '2021-05-28', '0000-00-00', 1),
(17, 5, 2, 'Tepung', 10, 100000, '2021-11-11', '2021-05-28', '0000-00-00', 1),
(18, 6, 2, 'Susu', 30, 20000, '2021-11-11', '2021-05-28', '0000-00-00', 1);
...
(129, 112, 7, 2, 'owner', 2, 34000, '2021-05-25', 'Dani', 0),
(130, 112, 9, 2, 'owner', 1, 15000, '2021-05-25', 'Dani', 0),
(131, 113, 9, 2, 'owner', 2, 30000, '2021-05-25', 'Duke', 0),
(132, 114, 11, 2, 'owner', 2, 60000, '2021-05-25', 'Droid', 0),
(135, 115, 17, 2, 'owner', 1, 20000, '2021-06-28', 'Die', 0),
(137, 116, 9, 2, 'owner', 2, 30000, '2021-05-29', 'Yeha', 0),
(138, 117, 9, 2, 'owner', 2, 30000, '2021-05-29', 'Morning', 0),
(139, 117, 14, 2, 'owner', 2, 80000, '2021-05-29', 'Morning', 0),
(140, 117, 16, 2, 'owner', 2, 40000, '2021-05-29', 'Morning', 0);
...
(10, 'Jay', 10000, 0.2, 0, 10000, '2021-10-08', '2021-05-27', 1);
...
(1, 2, 'kopi', '2021-05-20', 1),
(2, 1, 'susu', '2021-05-20', 1),
(3, 2, 'Topping', '2021-05-20', 1),
(4, 2, 'Oishi', '2021-05-20', 1),
(5, 2, 'Tepung', '2021-05-23', 1),
(6, 2, 'Susu', '2021-05-23', 1),
(7, 2, 'Gula', '2021-05-28', 1);
...
(17, 'Pokat', 20000, 15000, '2021-05-27', 'EC Signature Coffee Hot', '6d852ecc0537eafcf03ecb80a261c8f5.jpg');
...
(112, 2, 6, 'Dani', '2021-05-25', '39200', 'owner', 1),
(113, 2, 0, 'Duke', '2021-05-25', '30000', 'owner', 1),
(114, 2, 6, 'Droid', '2021-05-25', '50000', 'owner', 2),
(115, 2, 0, 'Die', '2021-06-28', '16000', 'owner', 1),
(116, 2, 6, 'Yeha', '2021-05-29', '24000', 'owner', 1),
(117, 2, 6, 'Morning', '2021-05-29', '140000', 'owner', 1);
...
(5, 2, 'Iwan', '085288404', '54040845', 'iwanjajaj', 'e10adc3949ba59abbe56e057f20f883e', NULL, 3, 0),
(6, 2, 'Iwan', '085288404', '54040845', 'iwanjajaj', 'e10adc3949ba59abbe56e057f20f883e', NULL, 3, 0),
(7, 2, 'granger', '88401040', '840404', 'granger', '827ccb0eea8a706c4c34a16891f84e7b', NULL, 2, 1),
(8, 1, 'Razornimes', '999', '1234567', 'ylex110@gmail.com', '73882ab1fa529d7273da0db6b49cc4f3', NULL, 2, 1),
...
(25, 9, 'owner', '1234435656', '49574560968', 'ownerowner@gmail.com', '96e79218965eb72c92a549dd5a330112', NULL, 1, 1);
...
--
ALTER TABLE `detailinventori`
  MODIFY `id_detailinventori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `detailtransaksi`
--
ALTER TABLE `detailtransaksi`
  MODIFY `id_detailtransaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
